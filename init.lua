...
vim.keymap.set('n', '<leader>or', require('telescope.builtin').oldfiles, { desc = '[O]pen recently opened files' })
vim.keymap.set('n', '<leader>ob', require('telescope.builtin').buffers, { desc = '[O]pen existing buffers' })
